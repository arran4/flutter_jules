...
class _SessionDetailScreenState extends State<SessionDetailScreen> {
  ...
  List<Widget> _buildSessionDetailActions(BuildContext context) {
    return [
      IconButton(
        icon: Icon(
      ...
      _buildNetworkStatusButton(context),
      IconButton(
  ...
  Widget _buildNetworkStatusButton(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: _buildSessionDetailActions(context),
        ),
        body: Column(
          children: [
            if (_isSending)
