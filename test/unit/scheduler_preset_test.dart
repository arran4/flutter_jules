...
void main() {
  group('SchedulerPreset', () {
    test('Standard preset has correct schedules', () {
      final preset = SchedulerPreset.presets.firstWhere(
        (p) => p.name == 'Standard',
      );
      ...
      expect(
        ...
        isTrue,
      ); // On open (name not checked by logic but by human)
      expect(
        schedules.any(
          (s) =>
    ...
    test('Battery Saver preset has correct schedules', () {
      ...
      expect(
        schedules.any((s) => s.taskType == RefreshTaskType.sendPendingMessages),
        isTrue,
      );
    });
    ...
    test('Never (Manual Only) preset has correct schedules', () {
      ...
      expect(
        schedules.any((s) => s.taskType == RefreshTaskType.refresh),
        isFalse,
      );
    });
