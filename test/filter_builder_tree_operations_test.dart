...
void main() {
  group('FilterElementBuilder Tree Operations Integration', () {
    ...
    test(
      ...
      expect(and1.children[0],
          equals(source)); // Source should still be there (Identity check)
    ...
    test('Create OR Above (Group with specific logic)', () {
      ...
      final newTree =
          FilterElementBuilder.groupFilters(root, target, source, isAnd: false);
    ...
    test('Add to Group (AddFilterToComposite)', () {
      ...
      final newTree =
          FilterElementBuilder.addFilterToComposite(root, targetGroup, source);
