...
void main() {
  group('FilterElementBuilder Operations Tests', () {
    test('replaceFilter should replace a node correctly', () {
      ...
      final newRoot = FilterElementBuilder.replaceFilter(root, child1, replacement);
    ...
    test('groupFilters should create grouping', () {
      ...
      final newRoot = FilterElementBuilder.groupFilters(root, child1, child2, isAnd: false);

      expect(newRoot, isA<AndElement>());
      final and = newRoot as AndElement;
      expect(and.children[0], isA<OrElement>()); // Child1 replaced by Or(Child1, Child2)
      final or = and.children[0] as OrElement;
    ...
    test('addFilterToComposite should add to existing composite', () {
      ...
      final newRoot = FilterElementBuilder.addFilterToComposite(root, composite, source);
